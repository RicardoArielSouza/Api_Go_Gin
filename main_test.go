...
import (
	...
	"github.com/RicardoArielSouza/api-go-gin/models"
...
func CriaAlunoMock() {
	aluno := models.Aluno{Nome: "Manu", CPF: "12345678901", RG: "123456789"}
...
func TestEditaUmAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Novo Nome do aluno TESTE", CPF: "10987654321", RG: "987654321"}
	...
	var alunoMock models.Aluno
	json.Unmarshal(resposta.Body.Bytes(), &alunoMock)
	assert.Equal(t, "10987654321", alunoMock.CPF)
	assert.Equal(t, "987654321", alunoMock.RG)
	//assert.Equal(t, "Novo Nome do aluno TESTE", alunoMock.Nome)
